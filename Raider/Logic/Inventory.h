...
namespace Inventory
{
    ...
    static void Init(AFortPlayerControllerAthena* PlayerController)
    {
        ...
        static std::vector<UFortWorldItemDefinition*> Items = {
            ...
            UObject::FindObject<UFortTrapItemDefinition>("FortTrapItemDefinition TID_Floor_Player_Jump_Pad_Athena"),
            UObject::FindObject<UFortTrapItemDefinition>("FortTrapItemDefinition TID_Floor_Player_Jump_Pad_Free_Direction_Athena"),
        ...
        for (auto& Item : Items)
        {
            ...
            {
                AddItemToSlot(PlayerController, Item, 0, EFortQuickBars::Secondary, 505);
                continue;
            }
